"use strict";(self.webpackChunkjsapi_angular_cli=self.webpackChunkjsapi_angular_cli||[]).push([[4054],{7818:(Ne,le,T)=>{T.d(le,{D:()=>ve,b:()=>Ge});var L=T(88290),D=T(46038),G=T(42596),H=T(69347),U=T(97838),R=T(67555),N=T(5660),k=T(3987),K=T(10606),Te=T(95781),Se=T(24404),ue=T(66541),F=T(49355),Z=T(91719),ge=T(27589),we=T(51941),me=T(73052),Pe=T(68125),ce=T(31573),Me=T(97594),de=T(53169),Oe=T(53827),Re=T(7524),fe=T(27439),Le=T(40900),He=T(60795),ke=T(52490),st=T(31184),Ue=T(63982),Et=T(85938),pt=T(93528),Pt=T(69446),Ve=T(53299),_t=T(90762),it=T(63243),be=T(59171),We=T(55362);function Ge(ne){const re=new _t.kG,{vertex:Xe,fragment:q,varyings:oe}=re;if((0,Ue.Sv)(Xe,ne),re.include(k.f),oe.add("vpos","vec3"),re.include(Le.k,ne),re.include(R.fQ,ne),re.include(F.L,ne),ne.hasColorTextureTransform&&re.include(fe.av),ne.output===G.H.Color||ne.output===G.H.Alpha){ne.hasNormalTextureTransform&&re.include(fe.NI),ne.hasEmissionTextureTransform&&re.include(fe.R5),ne.hasOcclusionTextureTransform&&re.include(fe.jF),ne.hasMetallicRoughnessTextureTransform&&re.include(fe.DT),(0,Ue.hY)(Xe,ne),re.include(N.O,ne),re.include(U.w,ne);const pe=ne.normalType===N.r.Attribute||ne.normalType===N.r.Compressed;pe&&ne.offsetBackfaces&&re.include(D.w),re.include(ge.Q,ne),re.include(ue.Bb,ne),ne.instancedColor&&re.attributes.add(We.T.INSTANCECOLOR,"vec4"),oe.add("vPositionLocal","vec3"),re.include(Te.D,ne),re.include(L.qj,ne),re.include(K.R,ne),re.include(Se.c,ne),Xe.uniforms.add(new pt.N("externalColor",W=>W.externalColor)),oe.add("vcolorExt","vec4"),ne.multipassEnabled&&oe.add("depth","float"),Xe.code.add(Ve.H`
      void main(void) {
        ...
        if (vcolorExt.a < ${Ve.H.float(He.b)}) {
          ...
          ${pe?Ve.H`vNormalWorld = dpNormal(vvLocalNormal(normalModel()));`:""}
          vpos = addVerticalOffset(vpos, localOrigin);
          ${ne.hasVertexTangents?"vTangent = dpTransformVertexTangent(tangent);":""}
          gl_Position = transformPosition(proj, view, vpos);
          ${pe&&ne.offsetBackfaces?"gl_Position = offsetBackfacingClipPosition(gl_Position, vpos, vNormalWorld, cameraPosition);":""}
        }
    ...
    `)}switch(ne.output){case G.H.Alpha:re.include(H.f5,ne),re.include(ke.z,ne),re.include(ce.l,ne),q.uniforms.add(new Pt.p("opacity",pe=>pe.opacity),new Pt.p("layerOpacity",pe=>pe.layerOpacity)),ne.hasColorTexture&&q.uniforms.add(new it.A("tex",pe=>pe.texture)),q.include(st.y),q.code.add(Ve.H`
      void main() {
        discardBySlice(vpos);
    ...
    `);break;case G.H.Color:re.include(H.f5,ne),re.include(me.XP,ne),re.include(we.K,ne),re.include(ke.z,ne),re.include(ne.instancedDoublePrecision?Re.hb:Re.XE,ne),re.include(ce.l,ne),(0,Ue.hY)(q,ne),q.uniforms.add(Xe.uniforms.get("localOrigin"),new Et.J("ambient",pe=>pe.ambient),new Et.J("diffuse",pe=>pe.diffuse),new Pt.p("opacity",pe=>pe.opacity),new Pt.p("layerOpacity",pe=>pe.layerOpacity)),ne.hasColorTexture&&q.uniforms.add(new it.A("tex",pe=>pe.texture)),re.include(Oe.jV,ne),re.include(de.T,ne),q.include(st.y),re.include(Me.k,ne),(0,me.PN)(q),(0,me.sC)(q),(0,Pe.F1)(q),q.code.add(Ve.H`
      void main() {
        discardBySlice(vpos);
        ${ne.multipassEnabled?"terrainDepthTest(depth);":""}
        ${ne.hasColorTexture?Ve.H`
    ...
    `)}return re.include(Z.s,ne),re}const ve=Object.freeze(Object.defineProperty({__proto__:null,build:Ge},Symbol.toStringTag,{value:"Module"}))},75799:(Ne,le,T)=>{T.d(le,{R:()=>it,b:()=>_t});var L=T(88290),D=T(46038),G=T(42596),H=T(69347),U=T(97838),R=T(67555),N=T(5660),k=T(3987),K=T(10606),Te=T(95781),Se=T(24404),ue=T(49355),F=T(91719),Z=T(51941),ge=T(73052),we=T(68125),me=T(31573),Pe=T(53169),ce=T(53827),Me=T(7524),de=T(40900),Oe=T(60795),Re=T(52490),fe=T(31184),Le=T(63982),He=T(85938),ke=T(93528),st=T(69446),Ue=T(53299),Et=T(90762),pt=T(63243),Pt=T(59171),Ve=T(55362);function _t(be){const We=new Et.kG,{vertex:Ge,fragment:ve,varyings:ne}=We;return(0,Le.Sv)(Ge,be),We.include(k.f),ne.add("vpos","vec3"),We.include(de.k,be),We.include(R.fQ,be),We.include(ue.L,be),be.output!==G.H.Color&&be.output!==G.H.Alpha||((0,Le.hY)(We.vertex,be),We.include(N.O,be),We.include(U.w,be),be.offsetBackfaces&&We.include(D.w),be.instancedColor&&We.attributes.add(Ve.T.INSTANCECOLOR,"vec4"),ne.add("vNormalWorld","vec3"),ne.add("localvpos","vec3"),be.multipassEnabled&&ne.add("depth","float"),We.include(Te.D,be),We.include(L.qj,be),We.include(K.R,be),We.include(Se.c,be),Ge.uniforms.add(new ke.N("externalColor",re=>re.externalColor)),ne.add("vcolorExt","vec4"),Ge.code.add(Ue.H`
      ...
      `)),be.output===G.H.Alpha&&(We.include(H.f5,be),We.include(Re.z,be),We.include(me.l,be),ve.uniforms.add(new st.p("opacity",re=>re.opacity),new st.p("layerOpacity",re=>re.layerOpacity)),be.hasColorTexture&&ve.uniforms.add(new pt.A("tex",re=>re.texture)),ve.include(fe.y),ve.code.add(Ue.H`
      void main() {
        discardBySlice(vpos);
    ...
    `)),be.output===G.H.Color&&(We.include(H.f5,be),We.include(ge.XP,be),We.include(Z.K,be),We.include(Re.z,be),We.include(be.instancedDoublePrecision?Me.hb:Me.XE,be),We.include(me.l,be),(0,Le.hY)(We.fragment,be),(0,we.Pe)(ve),(0,ge.PN)(ve),(0,ge.sC)(ve),ve.uniforms.add(Ge.uniforms.get("localOrigin"),Ge.uniforms.get("view"),new He.J("ambient",re=>re.ambient),new He.J("diffuse",re=>re.diffuse),new st.p("opacity",re=>re.opacity),new st.p("layerOpacity",re=>re.layerOpacity)),be.hasColorTexture&&ve.uniforms.add(new pt.A("tex",re=>re.texture)),We.include(ce.jV,be),We.include(Pe.T,be),ve.include(fe.y),(0,we.F1)(ve),ve.code.add(Ue.H`
      void main() {
        discardBySlice(vpos);
        ${be.multipassEnabled?Ue.H`terrainDepthTest(depth);`:""}
        ${be.hasColorTexture?Ue.H`
...
return fallOffFunction(vv, vn, 0.1);
  ...
  `),we}function F(we){return Math.max(10,20*we.computeScreenPixelSizeAtDist(Math.abs(4*we.relativeElevation)))}const Z=(0,D.a)(),ge=Object.freeze(Object.defineProperty({__proto__:null,build:ue,getRadius:F},Symbol.toStringTag,{value:"Module"}))},75475:(Ne,le,T)=>{T.d(le,{S:()=>F,b:()=>ue});var L=T(43589),D=T(84415),G=T(11202),H=T(95930),U=T(22946),R=T(69446),N=T(53299),k=T(90762),K=T(22166),Te=T(63243);const Se=4;function ue(){const Z=new k.kG,ge=Z.fragment;Z.include(D.k);const we=(Se+1)/2,me=1/(2*we*we);return ge.include(G.S),ge.uniforms.add(new Te.A("depthMap",Pe=>Pe.depthTexture),new K.R("tex",Pe=>Pe.colorTexture),new H.q("blurSize",Pe=>Pe.blurSize),new R.p("projScale",(Pe,ce)=>{const Me=(0,L.o)(ce.camera.eye,ce.camera.center);return Me>5e4?Math.max(0,Pe.projScale-(Me-5e4)):Pe.projScale}),new U.A("nearFar",(Pe,ce)=>ce.camera.nearFar)),ge.code.add(N.H`
  ...
  `),Z.outputs.add("fragBlur","float"),ge.code.add(N.H`
    void main(void) {
      float b = 0.0;
      float w_total = 0.0;
...
vNormalView = transformNormalViewFromGlobal * vNormalWorld;
        ...
        `);break;case H.r.ScreenDerivative:ue.vertex.code.add(R.H`void forwardNormal() {}`);break;default:(0,L.Bg)(F.normalType);case H.r.COUNT:}}class Te extends U.su{constructor(){super(...arguments),this.transformNormalViewFromGlobal=(0,D.a)()}}},96904:(Ne,le,T)=>{T.d(le,{su:()=>F,up:()=>ue});var L=T(93530),D=T(89568),G=T(8554),H=T(3987),U=T(59866),R=T(41841),N=T(85938),k=T(53299),K=T(1159),Te=T(11405),Se=T(73205);function ue(ge,we){ge.include(H.f);const me=ge.vertex;me.include(U.$,we),ge.varyings.add("vPositionWorldCameraRelative","vec3"),ge.varyings.add("vPosition_view","vec3"),me.uniforms.add(new N.J("transformWorldFromViewTH",Pe=>Pe.transformWorldFromViewTH),new N.J("transformWorldFromViewTL",Pe=>Pe.transformWorldFromViewTL),new Te.c("transformViewFromCameraRelativeRS",Pe=>Pe.transformViewFromCameraRelativeRS),new Se.g("transformProjFromView",Pe=>Pe.transformProjFromView),new K.j("transformWorldFromModelRS",Pe=>Pe.transformWorldFromModelRS),new R.B("transformWorldFromModelTH",Pe=>Pe.transformWorldFromModelTH),new R.B("transformWorldFromModelTL",Pe=>Pe.transformWorldFromModelTL)),me.code.add(k.H`vec3 positionWorldCameraRelative() {
...
return transform_CameraRelativeFromModel + rotatedModelPosition;
  ...
  `),ge.fragment.uniforms.add(new N.J("transformWorldFromViewTL",Pe=>Pe.transformWorldFromViewTL)),me.code.add(k.H`vec3 positionWorld() {
return transformWorldFromViewTL + vPositionWorldCameraRelative;
}`),ge.fragment.code.add(k.H`vec3 positionWorld() {
return transformWorldFromViewTL + vPositionWorldCameraRelative;
...
}`)}}var Z=T(79516),ge=T(63243);const we=(0,Z.f)(1,1,0,1),me=(0,Z.f)(1,0,1,1);function Pe(fe){fe.fragment.uniforms.add(new ge.A("depthTexture",(Le,He)=>He.mainDepth)),fe.fragment.constants.add("occludedHighlightFlag","vec4",we).add("unoccludedHighlightFlag","vec4",me),fe.fragment.code.add(R.H`void outputHighlight() {
...
forwardObjectAndLayerIdColor();
        ...
        `);break;case D.H.Normal:(0,de.Sv)(He,Le),fe.include(H.w,Le),fe.include(U.O,Le),fe.include(Te.Bb,Le),fe.include(K.D,Le),fe.include(ce.k,Le),st&&ke.uniforms.add(new ge.A("tex",Et=>Et.texture)),Le.normalType===U.r.ScreenDerivative&&fe.varyings.add("vPositionView","vec3"),He.code.add(R.H`
          void main(void) {
            vpos = getVertexInLocalOriginSpace();
        ...
        `);break;case D.H.Highlight:(0,de.Sv)(He,Le),fe.include(H.w,Le),fe.include(K.D,Le),fe.include(ce.k,Le),st&&ke.uniforms.add(new ge.A("tex",Ue=>Ue.texture)),He.code.add(R.H`void main(void) {
vpos = getVertexInLocalOriginSpace();
vpos = subtractOrigin(vpos);
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
...
}`))}const Se=(0,G.c)(),ue=(0,U.c)();var F=T(51941),Z=T(68125),ge=T(53169),we=T(64780),me=T(47832),Pe=T(92426);class ce extends me.x{constructor(X,ee){super(X,"bool",Pe.P.Pass,(Ee,Q,he)=>Ee.setUniform1b(X,ee(Q,he)))}}var Me=T(69446);T(55117),(0,G.c)();const Xe=.4;function pe(se){se.constants.add("ambientBoostFactor","float",Xe)}function W(se){se.uniforms.add(new Me.p("lightingGlobalFactor",(X,ee)=>ee.lighting.globalFactor))}function $(se,X){const ee=se.fragment;switch(se.include(F.K,X),X.pbrMode!==R.f7.Disabled&&se.include(ge.T,X),se.include(Te,X),se.include(we.e),ee.code.add(K.H`
    const float GAMMA_SRGB = 2.1;
    const float INV_GAMMA_SRGB = 0.4761904;
    ${X.pbrMode===R.f7.Disabled?"":"const vec3 GROUND_REFLECTANCE = vec3(0.2);"}
  `),pe(ee),W(ee),(0,Z.Pe)(ee),ee.code.add(K.H`
...
vec4 vvLocalNormal(vec3 _normal) { return vec4(_normal, 1.0); }`),te.vvColor?(xe.constants.add("vvColorNumber","int",bt),xe.uniforms.add(new U("vvColorValues",_e=>_e.vvColor.values,bt),new H("vvColorColors",_e=>_e.vvColor.colors,bt)),xe.code.add(R.H`
  ...
  `)}T(47832),T(92426);var N=T(69446),k=T(15182);function K(ue,F){!function Se(ue,F,Z){const ge=ue.fragment;switch(F.alphaDiscardMode!==k.JJ.Mask&&F.alphaDiscardMode!==k.JJ.MaskBlend||ge.uniforms.add(Z),F.alphaDiscardMode){case k.JJ.Blend:return ue.include(G);case k.JJ.Opaque:ge.code.add(D.H`void discardOrAdjustAlpha(inout vec4 color) {
color.a = 1.0;
}`);break;case k.JJ.Mask:ge.code.add(D.H`#define discardOrAdjustAlpha(color) { if (color.a < textureAlphaCutoff) { discard; } else { color.a = 1.0; } }`);break;case k.JJ.MaskBlend:ue.fragment.code.add(D.H`#define discardOrAdjustAlpha(color) { if (color.a < textureAlphaCutoff) { discard; } }`)}}(ue,F,new N.p("textureAlphaCutoff",Z=>Z.textureAlphaCutoff))}},31151:(Ne,le,T)=>{T.d(le,{GZ:()=>k});var L=T(46033),D=T(51675),G=T(70993),H=T(79516),U=T(22946),R=T(93528),N=T(53299);function k(F){F.fragment.uniforms.add(new R.N("projInfo",(Z,ge)=>function K(F){const Z=F.camera.projectionMatrix;return 0===Z[11]?(0,G.s)(Te,2/(F.camera.fullWidth*Z[0]),2/(F.camera.fullHeight*Z[5]),(1+Z[12])/Z[0],(1+Z[13])/Z[5]):(0,G.s)(Te,-2/(F.camera.fullWidth*Z[0]),-2/(F.camera.fullHeight*Z[5]),(1-Z[8])/Z[0],(1-Z[9])/Z[5])}(ge))),F.fragment.uniforms.add(new U.A("zScale",(Z,ge)=>function Se(F){return 0===F.camera.projectionMatrix[11]?(0,L.s)(ue,0,1):(0,L.s)(ue,1,0)}(ge))),F.fragment.code.add(N.H`vec3 reconstructPosition(vec2 fragCoord, float depth) {
